...
def generate_c(generator_arguments_file):
    mapping = {
        ...
        'idl__functions_create.c.em': 'detail/%s__functions_create.c',
        'idl__functions_destroy.c.em': 'detail/%s__functions_destroy.c',
        'idl__functions_fini.c.em': 'detail/%s__functions_fini.c',
        'idl__functions_init.c.em': 'detail/%s__functions_init.c',
        #'idl__functions_seq.c.em': 'detail/%s__functions_seq.c',
        'idl__functions_seq_are_equal.c.em': 'detail/%s__functions_seq_are_equal.c',
        'idl__functions_seq_copy.c.em': 'detail/%s__functions_seq_copy.c',
        'idl__functions_seq_create.c.em': 'detail/%s__functions_seq_create.c',
        'idl__functions_seq_destroy.c.em': 'detail/%s__functions_seq_destroy.c',
        'idl__functions_seq_fini.c.em': 'detail/%s__functions_seq_fini.c',
